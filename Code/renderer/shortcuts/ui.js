...
const FEATURES = [
  ...
  { id: 'portManagerTool',icon: ICONS.port,     name: 'Port Manager' },
   { id: 'teamActivityTool',icon: ICONS.team,    name: 'Team Activity' },
   { id: 'blueprintLibraryTool',icon: ICONS.blueprint,name: 'Blueprint Library' },
   { id: 'profileTool',icon: ICONS.profile,name: 'Profile' },
    { id: 'dockerTool',icon: ICONS.docker,name: 'Docker' },
    ...
    { id: 'videoTool',icon: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="2,4 18,10 2,16"/></svg>',name: 'Video Compressor' },
     { id: 'gmailTool',icon: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="16" height="12" rx="2"/><polyline points="2,4 10,11 18,4"/></svg>',name: 'Gmail Inbox' },
      ...
      { id: 'ecosystemWatcher',icon: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10 2a8 8 0 1 0 8 8"/><path d="M10 6a4 4 0 1 0 4 4"/><circle cx="10" cy="10" r="1.5"/></svg>',name: 'Ecosystem Dashboard' },
      { id: 'performanceTracker',icon: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10 2a8 8 0 1 0 8 8"/><path d="M10 6a4 4 0 1 0 4 4"/><circle cx="10" cy="10" r="1.5"/></svg>',name: 'Performance Tracker' },
